#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Testauthentication
# API Path   : POST /testauthentication
# Description: Submits data to the /testauthentication endpoint. The script reports the HTTP status code and a human-readable meaning.
#
# Required Parameters:
...
PATH_TEMPLATE = '/testauthentication'
HTTP_METHOD = 'POST'
