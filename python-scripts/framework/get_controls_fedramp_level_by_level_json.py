#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Controls Fedramp Level
# API Path   : GET /controls/fedramp/level/{level}
# Description: Retrieves data from the /controls/fedramp/level/{level} endpoint. The response is parsed as JSON and printed with standard indentation.
#
# Required Parameters:
...
#   python3 get_controls_fedramp_level_by_level_json.py \
...
PATH_TEMPLATE = '/controls/fedramp/level/{level}'
HTTP_METHOD = 'GET'
