...
# Description: Retrieves data from the /controls/rmf/confidentiality/{conLevel}/integrity/{intLevel}/availability/{availLevel} endpoint. The response is parsed as JSON and rendered as a PrettyTable.
#
# Required Parameters:
...
#   python3 get_controls_rmf_confidentiality_by_conlevel_integrity_by_intlevel_availability_by_availlevel_table.py \
