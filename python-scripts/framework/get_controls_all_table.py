...
# API Path   : GET /controls/all
# Description: Retrieves data from the /controls/all endpoint. The response is parsed as JSON and rendered as a PrettyTable.
#
# Required Parameters:
...
#   python3 get_controls_all_table.py \
