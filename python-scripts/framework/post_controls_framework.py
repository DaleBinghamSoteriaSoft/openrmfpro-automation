...
# API Path   : POST /controls/framework
# Description: Submits data to the /controls/framework endpoint. The script reports the HTTP status code and a human-readable meaning.
#
# Required Parameters:
...
#   4) frameworkFile      - Required multipart form file path.
#
# Optional Parameters:
#   None
#
# Command Line Example:
#   python3 post_controls_framework.py \
...
PATH_TEMPLATE = '/controls/framework'
HTTP_METHOD = 'POST'
