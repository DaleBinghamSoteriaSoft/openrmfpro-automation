...
# Description: Retrieves data from the /controls/{control} endpoint. The response is parsed as JSON and rendered as a PrettyTable.
#
# Required Parameters:
...
#   python3 get_controls_by_control_table.py \
