...
# API Path   : POST /controls/framework/controlccis
# Description: Submits data to the /controls/framework/controlccis endpoint. The script reports the HTTP status code and a human-readable meaning.
#
# Required Parameters:
...
#   4) frameworkControlCcisFile - Required multipart form file path.
#
# Optional Parameters:
#   None
#
# Command Line Example:
#   python3 post_controls_framework_controlccis.py \
#       https://example.openrmfpro.local \
#       my-application-key \
#       my-authorization-token \
#       <frameworkControlCcisFile>
# ============================================================
...
PATH_TEMPLATE = '/controls/framework/controlccis'
HTTP_METHOD = 'POST'
