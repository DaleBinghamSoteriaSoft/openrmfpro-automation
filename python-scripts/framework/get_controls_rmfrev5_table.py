...
# Description: Retrieves data from the /controls/rmfrev5 endpoint. The response is parsed as JSON and rendered as a PrettyTable.
#
# Required Parameters:
...
#   python3 get_controls_rmfrev5_table.py \
