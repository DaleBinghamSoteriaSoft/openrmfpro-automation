#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Controls Cciforcontrol Control
# API Path   : GET /controls/cciforcontrol/{frameworkId}/control/{control}
# Description: Retrieves data from the /controls/cciforcontrol/{frameworkId}/control/{control} endpoint. The response is parsed as JSON and rendered as a PrettyTable.
#
# Required Parameters:
...
#   5) control            - Required path parameter.
#
# Optional Parameters:
#    - rev5 (query), type: boolean, default: False
#
# Command Line Example:
#   python3 get_controls_cciforcontrol_by_frameworkid_control_by_control_table.py \
...
PATH_TEMPLATE = '/controls/cciforcontrol/{frameworkId}/control/{control}'
HTTP_METHOD = 'GET'
