#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Controls Fedramprev5
# API Path   : GET /controls/fedramprev5
# Description: Retrieves data from the /controls/fedramprev5 endpoint. The response is parsed as JSON and printed with standard indentation.
#
# Required Parameters:
...
#   python3 get_controls_fedramprev5_json.py \
...
PATH_TEMPLATE = '/controls/fedramprev5'
HTTP_METHOD = 'GET'
