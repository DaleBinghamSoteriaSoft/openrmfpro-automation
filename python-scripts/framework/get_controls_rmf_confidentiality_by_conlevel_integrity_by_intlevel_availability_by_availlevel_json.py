#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Controls Rmf Confidentiality Integrity Availability
# API Path   : GET /controls/rmf/confidentiality/{conLevel}/integrity/{intLevel}/availability/{availLevel}
# Description: Retrieves data from the /controls/rmf/confidentiality/{conLevel}/integrity/{intLevel}/availability/{availLevel} endpoint. The response is parsed as JSON and printed with standard indentation.
#
# Required Parameters:
...
#   4) conLevel           - Required path parameter.
#   5) intLevel           - Required path parameter.
#   6) availLevel         - Required path parameter.
#
# Optional Parameters:
#    - rev5 (query), type: boolean, default: False
#
# Command Line Example:
#   python3 get_controls_rmf_confidentiality_by_conlevel_integrity_by_intlevel_availability_by_availlevel_json.py \
...
PATH_TEMPLATE = '/controls/rmf/confidentiality/{conLevel}/integrity/{intLevel}/availability/{availLevel}'
HTTP_METHOD = 'GET'
