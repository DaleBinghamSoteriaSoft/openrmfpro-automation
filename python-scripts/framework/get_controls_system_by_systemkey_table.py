#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Controls System
# API Path   : GET /controls/system/{systemKey}
# Description: Retrieves data from the /controls/system/{systemKey} endpoint. The response is parsed as JSON and rendered as a PrettyTable.
#
# Required Parameters:
...
#   python3 get_controls_system_by_systemkey_table.py \
...
PATH_TEMPLATE = '/controls/system/{systemKey}'
HTTP_METHOD = 'GET'
