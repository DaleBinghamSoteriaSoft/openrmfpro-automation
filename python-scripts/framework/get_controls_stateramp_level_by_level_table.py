...
# Description: Retrieves data from the /controls/stateramp/level/{level} endpoint. The response is parsed as JSON and rendered as a PrettyTable.
#
# Required Parameters:
...
#   python3 get_controls_stateramp_level_by_level_table.py \
