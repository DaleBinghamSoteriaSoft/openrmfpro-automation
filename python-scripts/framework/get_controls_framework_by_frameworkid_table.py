#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Controls Framework
# API Path   : GET /controls/framework/{frameworkId}
# Description: Retrieves data from the /controls/framework/{frameworkId} endpoint. The response is parsed as JSON and rendered as a PrettyTable.
#
# Required Parameters:
...
#   python3 get_controls_framework_by_frameworkid_table.py \
...
PATH_TEMPLATE = '/controls/framework/{frameworkId}'
HTTP_METHOD = 'GET'
