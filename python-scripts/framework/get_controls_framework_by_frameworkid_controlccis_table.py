...
# Description: Retrieves data from the /controls/framework/{frameworkId}/controlccis endpoint. The response is parsed as JSON and rendered as a PrettyTable.
#
# Required Parameters:
...
#   python3 get_controls_framework_by_frameworkid_controlccis_table.py \
