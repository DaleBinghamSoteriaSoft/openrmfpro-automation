#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Controls Framework Levels
# API Path   : GET /controls/framework/{frameworkId}/levels
# Description: Retrieves data from the /controls/framework/{frameworkId}/levels endpoint. The response is parsed as JSON and printed with standard indentation.
#
# Required Parameters:
...
#   python3 get_controls_framework_by_frameworkid_levels_json.py \
...
PATH_TEMPLATE = '/controls/framework/{frameworkId}/levels'
HTTP_METHOD = 'GET'
