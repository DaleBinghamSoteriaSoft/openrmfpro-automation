#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Controls Rmfrev4
# API Path   : GET /controls/rmfrev4
# Description: Retrieves data from the /controls/rmfrev4 endpoint. The response is parsed as JSON and printed with standard indentation.
#
# Required Parameters:
...
#   python3 get_controls_rmfrev4_json.py \
...
PATH_TEMPLATE = '/controls/rmfrev4'
HTTP_METHOD = 'GET'
