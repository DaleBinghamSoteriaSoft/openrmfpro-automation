#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Controls Family All
# API Path   : GET /controls/family/all
# Description: Retrieves data from the /controls/family/all endpoint. The response is parsed as JSON and printed with standard indentation.
#
# Required Parameters:
...
#   python3 get_controls_family_all_json.py \
...
PATH_TEMPLATE = '/controls/family/all'
HTTP_METHOD = 'GET'
