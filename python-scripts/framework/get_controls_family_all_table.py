...
# Description: Retrieves data from the /controls/family/all endpoint. The response is parsed as JSON and rendered as a PrettyTable.
#
# Required Parameters:
...
#   python3 get_controls_family_all_table.py \
