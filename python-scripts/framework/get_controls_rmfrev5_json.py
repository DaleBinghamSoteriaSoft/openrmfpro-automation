#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Controls Rmfrev5
# API Path   : GET /controls/rmfrev5
# Description: Retrieves data from the /controls/rmfrev5 endpoint. The response is parsed as JSON and printed with standard indentation.
#
# Required Parameters:
...
#   python3 get_controls_rmfrev5_json.py \
...
PATH_TEMPLATE = '/controls/rmfrev5'
HTTP_METHOD = 'GET'
