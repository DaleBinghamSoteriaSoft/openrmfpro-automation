...
# API Path   : POST /controls/framework/levels
# Description: Submits data to the /controls/framework/levels endpoint. The script reports the HTTP status code and a human-readable meaning.
#
# Required Parameters:
...
#   4) frameworkLevelsFile - Required multipart form file path.
#
# Optional Parameters:
#   None
#
# Command Line Example:
#   python3 post_controls_framework_levels.py \
...
PATH_TEMPLATE = '/controls/framework/levels'
HTTP_METHOD = 'POST'
