#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Controls Fedramprev4
# API Path   : GET /controls/fedramprev4
# Description: Retrieves data from the /controls/fedramprev4 endpoint. The response is parsed as JSON and printed with standard indentation.
#
# Required Parameters:
...
#   python3 get_controls_fedramprev4_json.py \
...
PATH_TEMPLATE = '/controls/fedramprev4'
HTTP_METHOD = 'GET'
