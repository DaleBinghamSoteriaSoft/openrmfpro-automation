#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Controls Framework Controlccis
# API Path   : GET /controls/framework/{frameworkId}/controlccis
# Description: Retrieves data from the /controls/framework/{frameworkId}/controlccis endpoint. The response is parsed as JSON and printed with standard indentation.
#
# Required Parameters:
...
#   4) frameworkId        - Required path parameter.
#
# Optional Parameters:
#    - version (query), type: string
#    - levelcategory (query), type: string, default:
#    - levelvalue (query), type: string, default:
#
# Command Line Example:
#   python3 get_controls_framework_by_frameworkid_controlccis_json.py \
...
PATH_TEMPLATE = '/controls/framework/{frameworkId}/controlccis'
HTTP_METHOD = 'GET'
