#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Controls System Ccis
# API Path   : GET /controls/system/{systemKey}/ccis
# Description: Retrieves data from the /controls/system/{systemKey}/ccis endpoint. The response is parsed as JSON and rendered as a PrettyTable.
#
# Required Parameters:
...
#   python3 get_controls_system_by_systemkey_ccis_table.py \
...
PATH_TEMPLATE = '/controls/system/{systemKey}/ccis'
HTTP_METHOD = 'GET'
