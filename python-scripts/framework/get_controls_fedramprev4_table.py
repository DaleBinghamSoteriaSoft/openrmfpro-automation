...
# Description: Retrieves data from the /controls/fedramprev4 endpoint. The response is parsed as JSON and rendered as a PrettyTable.
#
# Required Parameters:
...
#   python3 get_controls_fedramprev4_table.py \
