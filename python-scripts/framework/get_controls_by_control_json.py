#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Controls
# API Path   : GET /controls/{control}
# Description: Retrieves data from the /controls/{control} endpoint. The response is parsed as JSON and printed with standard indentation.
#
# Required Parameters:
...
#   4) control            - Required path parameter.
#
# Optional Parameters:
#   None
#
# Command Line Example:
#   python3 get_controls_by_control_json.py \
...
PATH_TEMPLATE = '/controls/{control}'
HTTP_METHOD = 'GET'
