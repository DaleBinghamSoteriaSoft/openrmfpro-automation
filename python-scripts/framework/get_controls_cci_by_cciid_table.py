...
# Description: Retrieves data from the /controls/cci/{cciId} endpoint. The response is parsed as JSON and rendered as a PrettyTable.
#
# Required Parameters:
...
#   python3 get_controls_cci_by_cciid_table.py \
