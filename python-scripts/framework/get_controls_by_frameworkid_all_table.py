#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Controls All
# API Path   : GET /controls/{frameworkId}/all
# Description: Retrieves data from the /controls/{frameworkId}/all endpoint. The response is parsed as JSON and rendered as a PrettyTable.
#
# Required Parameters:
...
#   python3 get_controls_by_frameworkid_all_table.py \
...
PATH_TEMPLATE = '/controls/{frameworkId}/all'
HTTP_METHOD = 'GET'
