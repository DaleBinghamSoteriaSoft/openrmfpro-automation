...
# Description: Retrieves data from the /controls/stateramp endpoint. The response is parsed as JSON and rendered as a PrettyTable.
#
# Required Parameters:
...
#   python3 get_controls_stateramp_table.py \
