#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Controls Cci
# API Path   : GET /controls/cci/{cciId}
# Description: Retrieves data from the /controls/cci/{cciId} endpoint. The response is parsed as JSON and printed with standard indentation.
#
# Required Parameters:
...
#   4) cciId              - Required path parameter.
#
# Optional Parameters:
#   None
#
# Command Line Example:
#   python3 get_controls_cci_by_cciid_json.py \
...
PATH_TEMPLATE = '/controls/cci/{cciId}'
HTTP_METHOD = 'GET'
