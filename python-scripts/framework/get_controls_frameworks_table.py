#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Controls Frameworks
# API Path   : GET /controls/frameworks
# Description: Retrieves data from the /controls/frameworks endpoint. The response is parsed as JSON and rendered as a PrettyTable.
#
# Required Parameters:
...
#   python3 get_controls_frameworks_table.py \
...
PATH_TEMPLATE = '/controls/frameworks'
HTTP_METHOD = 'GET'
