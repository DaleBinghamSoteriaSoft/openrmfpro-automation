#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Controls Family Sections
# API Path   : POST /controls/family/sections
# Description: Submits data to the /controls/family/sections endpoint. The script reports the HTTP status code and a human-readable meaning.
#
# Required Parameters:
...
#   4) controlFamilySectionsFile - Required multipart form file path.
#
# Optional Parameters:
#   None
#
# Command Line Example:
#   python3 post_controls_family_sections.py \
#       https://example.openrmfpro.local \
#       my-application-key \
#       my-authorization-token \
#       <controlFamilySectionsFile>
# ============================================================
...
PATH_TEMPLATE = '/controls/family/sections'
HTTP_METHOD = 'POST'
