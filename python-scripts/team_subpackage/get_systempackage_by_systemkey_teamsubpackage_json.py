#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Systempackage Teamsubpackage
# API Path   : GET /systempackage/{systemKey}/teamsubpackage
# Description: Retrieves data from the /systempackage/{systemKey}/teamsubpackage endpoint. The response is parsed as JSON and printed with standard indentation.
#
# Required Parameters:
...
#   python3 get_systempackage_by_systemkey_teamsubpackage_json.py \
