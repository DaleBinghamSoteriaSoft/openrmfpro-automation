...
# Description: Retrieves data from the /teamsubpackages endpoint. The response is parsed as JSON and rendered as a PrettyTable.
#
# Required Parameters:
...
#   python3 get_teamsubpackages_table.py \
