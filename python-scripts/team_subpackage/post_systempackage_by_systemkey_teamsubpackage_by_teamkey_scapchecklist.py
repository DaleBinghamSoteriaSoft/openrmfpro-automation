#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Systempackage Teamsubpackage Scapchecklist
# API Path   : POST /systempackage/{systemKey}/teamsubpackage/{teamKey}/scapchecklist
# Description: Submits data to the /systempackage/{systemKey}/teamsubpackage/{teamKey}/scapchecklist endpoint. The script reports the HTTP status code and a human-readable meaning.
#
# Required Parameters:
...
#   5) teamKey            - Required path parameter.
#   6) checklistFile      - Required multipart form file path.
#
# Optional Parameters:
#   None
#
# Command Line Example:
#   python3 post_systempackage_by_systemkey_teamsubpackage_by_teamkey_scapchecklist.py \
...
PATH_TEMPLATE = '/systempackage/{systemKey}/teamsubpackage/{teamKey}/scapchecklist'
HTTP_METHOD = 'POST'
