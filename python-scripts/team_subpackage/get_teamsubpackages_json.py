#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Teamsubpackages
# API Path   : GET /teamsubpackages
# Description: Retrieves data from the /teamsubpackages endpoint. The response is parsed as JSON and printed with standard indentation.
#
# Required Parameters:
...
#   python3 get_teamsubpackages_json.py \
