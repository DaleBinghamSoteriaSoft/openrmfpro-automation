#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Systempackage Teamsubpackage Items
# API Path   : GET /systempackage/{systemKey}/teamsubpackage/items
# Description: Retrieves data from the /systempackage/{systemKey}/teamsubpackage/items endpoint. The response is parsed as JSON and printed with standard indentation.
#
# Required Parameters:
...
#
# Optional Parameters:
#    - teamKey (query), type: string, default:
#    - itemType (query), type: integer, default: 0
#    - page (query), type: integer, default: 1
#    - limit (query), type: integer, default: 50
#    - searchString (query), type: string, default:
#
# Command Line Example:
#   python3 get_systempackage_by_systemkey_teamsubpackage_items_json.py \
...
PATH_TEMPLATE = '/systempackage/{systemKey}/teamsubpackage/items'
HTTP_METHOD = 'GET'
