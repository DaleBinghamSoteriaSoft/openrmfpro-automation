#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Systempackage Teamsubpackage Patchscan
# API Path   : POST /systempackage/{systemKey}/teamsubpackage/{teamKey}/patchscan
# Description: Submits data to the /systempackage/{systemKey}/teamsubpackage/{teamKey}/patchscan endpoint. The script reports the HTTP status code and a human-readable meaning.
#
# Required Parameters:
...
#   6) patchFile          - Required multipart form file path.
#
# Optional Parameters:
#   None
#
# Command Line Example:
#   python3 post_systempackage_by_systemkey_teamsubpackage_by_teamkey_patchscan.py \
...
PATH_TEMPLATE = '/systempackage/{systemKey}/teamsubpackage/{teamKey}/patchscan'
HTTP_METHOD = 'POST'
