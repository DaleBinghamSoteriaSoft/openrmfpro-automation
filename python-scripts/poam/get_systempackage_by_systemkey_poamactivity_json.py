#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Systempackage Poamactivity
# API Path   : GET /systempackage/{systemKey}/poamactivity
# Description: Retrieves data from the /systempackage/{systemKey}/poamactivity endpoint. The response is parsed as JSON and printed with standard indentation.
#
# Required Parameters:
...
#   python3 get_systempackage_by_systemkey_poamactivity_json.py \
...
PATH_TEMPLATE = '/systempackage/{systemKey}/poamactivity'
HTTP_METHOD = 'GET'
