#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Systempackage Mitigationstatement
# API Path   : PUT /systempackage/{systemKey}/mitigationstatement/{statementId}
# Description: Updates data on the /systempackage/{systemKey}/mitigationstatement/{statementId} endpoint. The script reports the HTTP status code and a human-readable meaning.
#
# Required Parameters:
...
#   5) statementId        - Required path parameter.
#   6) mitigationTitle    - Required multipart form field (string).
#   7) mitigationCategory - Required multipart form field (string).
#   8) mitigationStatement - Required multipart form field (string).
#
# Optional Parameters:
#   None
#
# Command Line Example:
#   python3 put_systempackage_by_systemkey_mitigationstatement_by_statementid.py \
...
PATH_TEMPLATE = '/systempackage/{systemKey}/mitigationstatement/{statementId}'
HTTP_METHOD = 'PUT'
