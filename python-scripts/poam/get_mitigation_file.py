#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Mitigation File
# API Path   : GET /mitigation
# Description: Retrieves data from the /mitigation endpoint and saves the response body to a local Excel file.
#
# Required Parameters:
...
#   python3 get_mitigation_file.py \
...
def determine_output_path(options: dict[str, str]) -> Path:
    ...
    return downloads_root / f"mitigation-list-{timestamp}.{FILE_EXTENSION_HINT}"
