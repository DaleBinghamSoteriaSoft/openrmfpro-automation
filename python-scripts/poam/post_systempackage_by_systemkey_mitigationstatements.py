#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Systempackage Mitigationstatements
# API Path   : POST /systempackage/{systemKey}/mitigationstatements
# Description: Submits data to the /systempackage/{systemKey}/mitigationstatements endpoint. The script reports the HTTP status code and a human-readable meaning.
#
# Required Parameters:
...
#   python3 post_systempackage_by_systemkey_mitigationstatements.py \
...
PATH_TEMPLATE = '/systempackage/{systemKey}/mitigationstatements'
HTTP_METHOD = 'POST'
