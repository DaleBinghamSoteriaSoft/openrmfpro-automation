...
# API Path   : POST /systempackage/{systemKey}/milestoneevent
# Description: Submits data to the /systempackage/{systemKey}/milestoneevent endpoint. The script reports the HTTP status code and a human-readable meaning.
#
# Required Parameters:
...
#   6) description        - Required multipart form field (string).
#   7) startDateTime      - Required multipart form field (string).
#   8) endDateTime        - Required multipart form field (string).
#   9) location           - Required multipart form field (string).
#
# Optional Parameters:
...
#   python3 post_systempackage_by_systemkey_milestoneevent.py \
...
PATH_TEMPLATE = '/systempackage/{systemKey}/milestoneevent'
HTTP_METHOD = 'POST'
...
positional_values = sys.argv[4:4 + 6]
optional_values = sys.argv[4 + 6:]
