#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Systempackage Poams
# API Path   : GET /systempackage/{systemKey}/poams
# Description: Retrieves data from the /systempackage/{systemKey}/poams endpoint. The response is parsed as JSON and printed with standard indentation.
#
# Required Parameters:
...
#    - showManual (query), type: boolean, default: True
#    - showChecklist (query), type: boolean, default: True
#    - showPatch (query), type: boolean, default: True
#    - showCompliance (query), type: boolean, default: True
#    - showInherited (query), type: boolean, default: True
#    - showTechVuln (query), type: boolean, default: True
#    - milestoneEventId (query), type: string, default:
#    - grouped (query), type: boolean, default: False
#    - onlyMitigations (query), type: boolean, default: False
#    - begin (query), type: string, default:
#    - end (query), type: string, default:
#    - completedByDate (query), type: string, default:
#    - device (query), type: string, default:
#    - tags (query), type: string, default:
#    - needsUpdated (query), type: boolean, default: False
#    - securityCheck (query), type: string, default:
#    - onlyFalsePositives (query), type: boolean, default: False
#    - onlyMisleadingInformation (query), type: boolean, default: False
#
# Command Line Example:
#   python3 get_systempackage_by_systemkey_poams_json.py \
...
PATH_TEMPLATE = '/systempackage/{systemKey}/poams'
HTTP_METHOD = 'GET'
