#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Systempackage Milestoneevents
# API Path   : GET /systempackage/{systemKey}/milestoneevents
# Description: Retrieves data from the /systempackage/{systemKey}/milestoneevents endpoint. The response is parsed as JSON and printed with standard indentation.
#
# Required Parameters:
...
#
# Optional Parameters:
#    - includePastEvents (query), type: boolean, default: False
#
# Command Line Example:
#   python3 get_systempackage_by_systemkey_milestoneevents_json.py \
...
PATH_TEMPLATE = '/systempackage/{systemKey}/milestoneevents'
HTTP_METHOD = 'GET'
