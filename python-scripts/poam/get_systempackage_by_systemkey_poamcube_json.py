#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Systempackage Poamcube
# API Path   : GET /systempackage/{systemKey}/poamcube
# Description: Retrieves data from the /systempackage/{systemKey}/poamcube endpoint. The response is parsed as JSON and printed with standard indentation.
#
# Required Parameters:
...
#   python3 get_systempackage_by_systemkey_poamcube_json.py \
...
PATH_TEMPLATE = '/systempackage/{systemKey}/poamcube'
HTTP_METHOD = 'GET'
