...
# API Path   : POST /systempackage/{systemKey}/mitigationstatement
# Description: Submits data to the /systempackage/{systemKey}/mitigationstatement endpoint. The script reports the HTTP status code and a human-readable meaning.
#
# Required Parameters:
...
#   5) mitigationTitle    - Required multipart form field (string).
#   6) mitigationCategory - Required multipart form field (string).
#   7) mitigationStatement - Required multipart form field (string).
#
# Optional Parameters:
#   None
#
# Command Line Example:
#   python3 post_systempackage_by_systemkey_mitigationstatement.py \
...
PATH_TEMPLATE = '/systempackage/{systemKey}/mitigationstatement'
HTTP_METHOD = 'POST'
