#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Systempackage Milestoneevent
# API Path   : PUT /systempackage/{systemKey}/milestoneevent/{eventId}
# Description: Updates data on the /systempackage/{systemKey}/milestoneevent/{eventId} endpoint. The script reports the HTTP status code and a human-readable meaning.
#
# Required Parameters:
...
#   5) eventId            - Required path parameter.
#   6) title              - Required multipart form field (string).
#   7) description        - Required multipart form field (string).
#   8) startDateTime      - Required multipart form field (string).
#   9) endDateTime        - Required multipart form field (string).
#   10) location           - Required multipart form field (string).
#
# Optional Parameters:
#    - status (multipart form), type: string, default: Scheduled
#    - statusDate (multipart form), type: string, default:
#
# Command Line Example:
#   python3 put_systempackage_by_systemkey_milestoneevent_by_eventid.py \
...
PATH_TEMPLATE = '/systempackage/{systemKey}/milestoneevent/{eventId}'
HTTP_METHOD = 'PUT'
...
positional_values = sys.argv[4:4 + 7]
optional_values = sys.argv[4 + 7:]
