#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Systempackage Mitigation
# API Path   : GET /systempackage/{systemKey}/mitigation
# Description: Retrieves data from the /systempackage/{systemKey}/mitigation endpoint. The response is parsed as JSON and printed with standard indentation.
#
# Required Parameters:
...
#   python3 get_systempackage_by_systemkey_mitigation_json.py \
