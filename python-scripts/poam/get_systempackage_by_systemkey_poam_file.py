#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Systempackage Poam File
# API Path   : GET /systempackage/{systemKey}/poam
# Description: Retrieves data from the /systempackage/{systemKey}/poam endpoint and saves the response body to a local Excel file.
#
# Required Parameters:
...
#   python3 get_systempackage_by_systemkey_poam_file.py \
...
def determine_output_path(options: dict[str, str], system_key: str) -> Path:
    ...
    return downloads_root / f"{safe_system_key}-poam-list-{timestamp}.{FILE_EXTENSION_HINT}"
