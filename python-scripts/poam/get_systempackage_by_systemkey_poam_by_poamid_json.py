...
# API Path   : GET /systempackage/{systemKey}/poam/{poamId}
# Description: Retrieves data from the /systempackage/{systemKey}/poam/{poamId} endpoint. The response is parsed as JSON and printed with standard indentation.
#
# Required Parameters:
...
#   python3 get_systempackage_by_systemkey_poam_by_poamid_json.py \
