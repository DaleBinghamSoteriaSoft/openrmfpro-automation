#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Overlay
# API Path   : GET /overlay
# Description: Retrieves data from the /overlay endpoint. The response is parsed as JSON and printed with standard indentation.
#
# Required Parameters:
