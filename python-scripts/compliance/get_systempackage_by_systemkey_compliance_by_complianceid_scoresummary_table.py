#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Systempackage Compliance Scoresummary
# API Path   : GET /systempackage/{systemKey}/compliance/{complianceId}/scoresummary
# Description: Retrieves data from the /systempackage/{systemKey}/compliance/{complianceId}/scoresummary endpoint. The response is parsed as JSON and rendered as a PrettyTable.
#
# Required Parameters:
...
#   python3 get_systempackage_by_systemkey_compliance_by_complianceid_scoresummary_table.py \
...
PATH_TEMPLATE = '/systempackage/{systemKey}/compliance/{complianceId}/scoresummary'
HTTP_METHOD = 'GET'
