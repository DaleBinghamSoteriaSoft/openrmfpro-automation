#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Systempackage Compliancescorehistory
# API Path   : GET /systempackage/{systemKey}/compliancescorehistory
# Description: Retrieves data from the /systempackage/{systemKey}/compliancescorehistory endpoint. The response is parsed as JSON and printed with standard indentation.
#
# Required Parameters:
...
#   python3 get_systempackage_by_systemkey_compliancescorehistory_json.py \
...
PATH_TEMPLATE = '/systempackage/{systemKey}/compliancescorehistory'
HTTP_METHOD = 'GET'
