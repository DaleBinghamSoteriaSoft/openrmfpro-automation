#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Systempackage Compliancestatements
# API Path   : POST /systempackage/{systemKey}/compliancestatements
# Description: Submits data to the /systempackage/{systemKey}/compliancestatements endpoint. The script reports the HTTP status code and a human-readable meaning.
#
# Required Parameters:
...
#   5) complianceStatementsFile - Required multipart form file path.
#
# Optional Parameters:
#   None
#
# Command Line Example:
#   python3 post_systempackage_by_systemkey_compliancestatements.py \
#       https://example.openrmfpro.local \
#       my-application-key \
#       my-authorization-token \
#       <systemKey> \
#       <complianceStatementsFile>
# ============================================================
...
PATH_TEMPLATE = '/systempackage/{systemKey}/compliancestatements'
HTTP_METHOD = 'POST'
