...
# API Path   : GET /systempackage/{systemKey}/compliance
# Description: Retrieves data from the /systempackage/{systemKey}/compliance endpoint. The response is parsed as JSON and rendered as a PrettyTable.
#
# Required Parameters:
...
#
# Optional Parameters:
#    - complianceId (query), type: string, default:
#
# Command Line Example:
#   python3 get_systempackage_by_systemkey_compliance_table.py \
