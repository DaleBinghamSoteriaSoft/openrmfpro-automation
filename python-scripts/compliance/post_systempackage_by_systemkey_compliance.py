#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Systempackage Compliance
# API Path   : POST /systempackage/{systemKey}/compliance
# Description: Submits data to the /systempackage/{systemKey}/compliance endpoint. The script reports the HTTP status code and a human-readable meaning.
#
# Required Parameters:
...
#   python3 post_systempackage_by_systemkey_compliance.py \
...
PATH_TEMPLATE = '/systempackage/{systemKey}/compliance'
HTTP_METHOD = 'POST'
