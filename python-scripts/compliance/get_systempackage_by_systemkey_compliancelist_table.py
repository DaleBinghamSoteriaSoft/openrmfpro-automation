#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Systempackage Compliancelist
# API Path   : GET /systempackage/{systemKey}/compliancelist
# Description: Retrieves data from the /systempackage/{systemKey}/compliancelist endpoint. The response is parsed as JSON and rendered as a PrettyTable.
#
# Required Parameters:
...
#   python3 get_systempackage_by_systemkey_compliancelist_table.py \
...
PATH_TEMPLATE = '/systempackage/{systemKey}/compliancelist'
HTTP_METHOD = 'GET'
