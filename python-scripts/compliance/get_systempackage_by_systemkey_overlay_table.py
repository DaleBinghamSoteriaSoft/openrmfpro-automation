#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Systempackage Overlay
# API Path   : GET /systempackage/{systemKey}/overlay
# Description: Retrieves data from the /systempackage/{systemKey}/overlay endpoint. The response is parsed as JSON and rendered as a PrettyTable.
#
# Required Parameters:
...
#   python3 get_systempackage_by_systemkey_overlay_table.py \
...
PATH_TEMPLATE = '/systempackage/{systemKey}/overlay'
HTTP_METHOD = 'GET'
