#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Systempackage Compliance Records
# API Path   : GET /systempackage/{systemKey}/compliance/{complianceId}/records
# Description: Retrieves data from the /systempackage/{systemKey}/compliance/{complianceId}/records endpoint. The response is parsed as JSON and rendered as a PrettyTable.
#
# Required Parameters:
...
#   python3 get_systempackage_by_systemkey_compliance_by_complianceid_records_table.py \
...
PATH_TEMPLATE = '/systempackage/{systemKey}/compliance/{complianceId}/records'
HTTP_METHOD = 'GET'
