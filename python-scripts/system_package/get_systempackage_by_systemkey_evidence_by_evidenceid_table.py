...
# Description: Retrieves data from the /systempackage/{systemKey}/evidence/{evidenceid} endpoint. The response is parsed as JSON and rendered as a PrettyTable.
#
# Required Parameters:
...
#   python3 get_systempackage_by_systemkey_evidence_by_evidenceid_table.py \
