#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Systempackage Summarypptx
# API Path   : GET /systempackage/{systemKey}/summarypptx
# Description: Retrieves data from the /systempackage/{systemKey}/summarypptx endpoint. The response body is saved to a local file.
#
# Required Parameters:
...
#   python3 get_systempackage_by_systemkey_summarypptx_file.py \
...
PATH_TEMPLATE = '/systempackage/{systemKey}/summarypptx'
HTTP_METHOD = 'GET'
...
FILE_EXTENSION_HINT = 'pptx'
ACCEPT_HEADER = 'application/vnd.openxmlformats-officedocument.presentationml.presentation'
...
def determine_output_path(response, options: dict[str, str], system_key: str) -> Path:
    ...
    filename = f"{safe_system_key}_presentation_{timestamp}.{extension}"
