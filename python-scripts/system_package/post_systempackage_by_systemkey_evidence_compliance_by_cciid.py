#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Systempackage Evidence Compliance
# API Path   : POST /systempackage/{systemKey}/evidence/compliance/{cciId}
# Description: Submits data to the /systempackage/{systemKey}/evidence/compliance/{cciId} endpoint. The script reports the HTTP status code and a human-readable meaning.
#
# Required Parameters:
...
#   5) cciId              - Required path parameter.
#   6) title              - Required multipart form field (string).
#   7) evidenceFile       - Required multipart form file path.
#
# Optional Parameters:
...
#   python3 post_systempackage_by_systemkey_evidence_compliance_by_cciid.py \
...
PATH_TEMPLATE = '/systempackage/{systemKey}/evidence/compliance/{cciId}'
HTTP_METHOD = 'POST'
