...
# API Path   : DELETE /systempackage/{systemKey}/readinesssettings
# Description: Deletes data through the /systempackage/{systemKey}/readinesssettings endpoint. The script reports the HTTP status code and a human-readable meaning.
#
# Required Parameters:
...
#   python3 delete_systempackage_by_systemkey_readinesssettings.py \
