...
# Description: Retrieves data from the /systempackages endpoint. The response is parsed as JSON and rendered as a PrettyTable.
#
# Required Parameters:
...
#   python3 get_systempackages_table.py \
