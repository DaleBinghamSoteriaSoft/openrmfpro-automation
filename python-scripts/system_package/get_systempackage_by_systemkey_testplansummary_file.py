#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Systempackage Testplansummary
# API Path   : GET /systempackage/{systemKey}/testplansummary
# Description: Retrieves data from the /systempackage/{systemKey}/testplansummary endpoint. The response body is saved to a local file.
#
# Required Parameters:
...
#   python3 get_systempackage_by_systemkey_testplansummary_file.py \
...
PATH_TEMPLATE = '/systempackage/{systemKey}/testplansummary'
HTTP_METHOD = 'GET'
...
def determine_output_path(response, options: dict[str, str], system_key: str) -> Path:
    ...
    filename = f"{safe_system_key}_test-plan-summary_{timestamp}.{extension}"
