#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Systempackage Score
# API Path   : GET /systempackage/{systemKey}/score
# Description: Retrieves data from the /systempackage/{systemKey}/score endpoint. The response is parsed as JSON and printed with standard indentation.
#
# Required Parameters:
...
#   python3 get_systempackage_by_systemkey_score_json.py \
...
PATH_TEMPLATE = '/systempackage/{systemKey}/score'
HTTP_METHOD = 'GET'
