#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Systempackage
# API Path   : PUT /systempackage/{systemKey}
# Description: Updates data on the /systempackage/{systemKey} endpoint. The script reports the HTTP status code and a human-readable meaning.
#
# Required Parameters:
...
#   5) title              - Required multipart form field (string).
#
# Optional Parameters:
#    - description (multipart form), type: string, default:
#    - confidentiality (multipart form), type: integer, default: 0
#    - integrity (multipart form), type: integer, default: 0
#    - availability (multipart form), type: integer, default: 0
#    - component (multipart form), type: string, default:
#    - registrationNumber (multipart form), type: string, default:
#    - systemType (multipart form), type: string, default:
#    - pocName (multipart form), type: string, default:
#    - pocPhone (multipart form), type: string, default:
#    - pocEmail (multipart form), type: string, default:
#    - ombProjectId (multipart form), type: string, default:
#    - securityCosts (multipart form), type: string, default:
#    - cnssi (multipart form), type: boolean, default: False
#    - pii (multipart form), type: boolean, default: False
#    - packageType (multipart form), type: integer, default: 0
#    - fedrampLevel (multipart form), type: integer, default: 0
#    - staterampLevel (multipart form), type: integer, default: 10
#    - authorizationType (multipart form), type: integer, default: 0
#    - authorizationStatus (multipart form), type: integer, default: 0
#    - acronym (multipart form), type: string, default:
#    - versionNumber (multipart form), type: string, default:
#    - authorizationDate (multipart form), type: string, default:
#    - authorizationComments (multipart form), type: string, default:
#    - authorizationExpiresDate (multipart form), type: string, default:
#
# Command Line Example:
#   python3 put_systempackage_by_systemkey.py \
...
PATH_TEMPLATE = '/systempackage/{systemKey}'
HTTP_METHOD = 'PUT'
