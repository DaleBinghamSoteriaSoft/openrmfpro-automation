#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Systempackage Evidence Download
# API Path   : GET /systempackage/{systemKey}/evidence/{evidenceid}/download
# Description: Retrieves data from the /systempackage/{systemKey}/evidence/{evidenceid}/download endpoint. The response body is saved to a local file.
#
# Required Parameters:
...
#   5) evidenceid         - Required path parameter.
#
# Optional Parameters:
#   outputFile (script option) - Local path to save the downloaded file.
#
# Command Line Example:
#   python3 get_systempackage_by_systemkey_evidence_by_evidenceid_download_file.py \
...
PATH_TEMPLATE = '/systempackage/{systemKey}/evidence/{evidenceid}/download'
HTTP_METHOD = 'GET'
