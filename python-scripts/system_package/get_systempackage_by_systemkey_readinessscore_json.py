#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Systempackage Readinessscore
# API Path   : GET /systempackage/{systemKey}/readinessscore
# Description: Retrieves data from the /systempackage/{systemKey}/readinessscore endpoint. The response is parsed as JSON and printed with standard indentation.
#
# Required Parameters:
...
#   python3 get_systempackage_by_systemkey_readinessscore_json.py \
...
PATH_TEMPLATE = '/systempackage/{systemKey}/readinessscore'
HTTP_METHOD = 'GET'
