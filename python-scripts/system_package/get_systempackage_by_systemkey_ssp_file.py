#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Systempackage Ssp
# API Path   : GET /systempackage/{systemKey}/ssp
# Description: Retrieves data from the /systempackage/{systemKey}/ssp endpoint. The response body is saved to a local file.
#
# Required Parameters:
...
#   python3 get_systempackage_by_systemkey_ssp_file.py \
...
PATH_TEMPLATE = '/systempackage/{systemKey}/ssp'
HTTP_METHOD = 'GET'
...
def determine_output_path(response, options: dict[str, str], system_key: str) -> Path:
    ...
    filename = f"{safe_system_key}_ssp_{timestamp}.{extension}"
