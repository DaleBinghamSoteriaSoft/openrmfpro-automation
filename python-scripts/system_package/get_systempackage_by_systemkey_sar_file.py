#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Systempackage Sar
# API Path   : GET /systempackage/{systemKey}/sar
# Description: Retrieves data from the /systempackage/{systemKey}/sar endpoint. The response body is saved to a local file.
#
# Required Parameters:
...
#   python3 get_systempackage_by_systemkey_sar_file.py \
...
PATH_TEMPLATE = '/systempackage/{systemKey}/sar'
HTTP_METHOD = 'GET'
...
def determine_output_path(response, options: dict[str, str], system_key: str) -> Path:
    ...
    filename = f"{safe_system_key}_sar_{timestamp}.{extension}"
