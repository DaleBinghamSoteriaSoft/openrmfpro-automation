#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Systempackage Preferences
# API Path   : PUT /systempackage/{systemKey}/preferences
# Description: Updates data on the /systempackage/{systemKey}/preferences endpoint. The script reports the HTTP status code and a human-readable meaning.
#
# Required Parameters:
...
#
# Optional Parameters:
#    - allowUncredentialedScans (multipart form), type: boolean, default:
#   False
#    - allowUncredentialedScanVulns (multipart form), type: boolean,
#   default: False
#    - allowUncredentialedScanSoftware (multipart form), type: boolean,
#   default: False
#    - allowSeverityOverride (multipart form), type: boolean, default: False
#    - tspSingleChecklist (multipart form), type: boolean, default: False
#    - tspSingleDevice (multipart form), type: boolean, default: False
#    - ipMasking (multipart form), type: string, default: both
#    - enablePoamTracking (multipart form), type: boolean, default: True
#    - classification (multipart form), type: string, default: none
#    - classificationColor (multipart form), type: string, default: none
#
# Command Line Example:
#   python3 put_systempackage_by_systemkey_preferences.py \
...
PATH_TEMPLATE = '/systempackage/{systemKey}/preferences'
HTTP_METHOD = 'PUT'
...
OPTIONAL_BODY_PARAMETER_NAMES = [
    'allowUncredentialedScans',
    'allowUncredentialedScanVulns',
    'allowUncredentialedScanSoftware',
