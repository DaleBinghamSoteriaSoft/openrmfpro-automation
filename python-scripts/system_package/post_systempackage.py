...
# API Path   : POST /systempackage
# Description: Submits data to the /systempackage endpoint. The script reports the HTTP status code and a human-readable meaning.
#
# Required Parameters:
...
#   4) systemKey          - Required multipart form field (string).
...
#    - addUserToSystemPackage (multipart form), type: boolean, default:
#   False
...
#    - frameworkId (multipart form), type: string, default:
#    - frameworkLevelList (multipart form), type: string, default:
#
# Command Line Example:
#   python3 post_systempackage.py \
