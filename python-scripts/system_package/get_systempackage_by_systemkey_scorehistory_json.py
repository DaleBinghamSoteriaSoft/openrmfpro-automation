#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Systempackage Scorehistory
# API Path   : GET /systempackage/{systemKey}/scorehistory
# Description: Retrieves data from the /systempackage/{systemKey}/scorehistory endpoint. The response is parsed as JSON and printed with standard indentation.
#
# Required Parameters:
...
#    - groupby (query), type: string, default:
#
# Command Line Example:
#   python3 get_systempackage_by_systemkey_scorehistory_json.py \
...
PATH_TEMPLATE = '/systempackage/{systemKey}/scorehistory'
HTTP_METHOD = 'GET'
