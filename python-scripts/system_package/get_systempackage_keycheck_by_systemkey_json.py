#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Systempackage Keycheck
# API Path   : GET /systempackage/keycheck/{systemKey}
# Description: Retrieves data from the /systempackage/keycheck/{systemKey} endpoint. The response is parsed as JSON and printed with standard indentation.
#
# Required Parameters:
...
#   python3 get_systempackage_keycheck_by_systemkey_json.py \
...
PATH_TEMPLATE = '/systempackage/keycheck/{systemKey}'
HTTP_METHOD = 'GET'
