#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Systempackage Evidence
# API Path   : GET /systempackage/{systemKey}/evidence
# Description: Retrieves data from the /systempackage/{systemKey}/evidence endpoint. The response is parsed as JSON and printed with standard indentation.
#
# Required Parameters:
...
#
# Optional Parameters:
#    - general (query), type: boolean, default: True
#    - checklist (query), type: boolean, default: True
#    - statement (query), type: boolean, default: True
#    - poam (query), type: boolean, default: True
#
# Command Line Example:
#   python3 get_systempackage_by_systemkey_evidence_json.py \
...
PATH_TEMPLATE = '/systempackage/{systemKey}/evidence'
HTTP_METHOD = 'GET'
