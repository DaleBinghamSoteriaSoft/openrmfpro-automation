#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Systempackage Evidence General
# API Path   : POST /systempackage/{systemKey}/evidence/general
# Description: Submits data to the /systempackage/{systemKey}/evidence/general endpoint. The script reports the HTTP status code and a human-readable meaning.
#
# Required Parameters:
...
#   5) evidenceFile       - Required multipart form file path.
#
# Optional Parameters:
#    - allowOverwrite (multipart form), type: boolean, default: False
#
# Command Line Example:
#   python3 post_systempackage_by_systemkey_evidence_general.py \
...
PATH_TEMPLATE = '/systempackage/{systemKey}/evidence/general'
HTTP_METHOD = 'POST'
