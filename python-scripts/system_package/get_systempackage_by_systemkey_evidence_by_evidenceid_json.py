...
# API Path   : GET /systempackage/{systemKey}/evidence/{evidenceid}
# Description: Retrieves data from the /systempackage/{systemKey}/evidence/{evidenceid} endpoint. The response is parsed as JSON and printed with standard indentation.
#
# Required Parameters:
...
#   python3 get_systempackage_by_systemkey_evidence_by_evidenceid_json.py \
...
PATH_TEMPLATE = '/systempackage/{systemKey}/evidence/{evidenceid}'
HTTP_METHOD = 'GET'
