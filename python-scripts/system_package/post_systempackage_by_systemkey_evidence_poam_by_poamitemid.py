#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Systempackage Evidence Poam
# API Path   : POST /systempackage/{systemKey}/evidence/poam/{poamItemId}
# Description: Submits data to the /systempackage/{systemKey}/evidence/poam/{poamItemId} endpoint. The script reports the HTTP status code and a human-readable meaning.
#
# Required Parameters:
...
#   5) poamItemId         - Required path parameter.
...
#   python3 post_systempackage_by_systemkey_evidence_poam_by_poamitemid.py \
...
PATH_TEMPLATE = '/systempackage/{systemKey}/evidence/poam/{poamItemId}'
HTTP_METHOD = 'POST'
