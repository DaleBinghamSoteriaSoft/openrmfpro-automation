#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Systempackage Sspcontrolmatrix
# API Path   : GET /systempackage/{systemKey}/sspcontrolmatrix
# Description: Retrieves data from the /systempackage/{systemKey}/sspcontrolmatrix endpoint. The response body is saved to a local file.
#
# Required Parameters:
...
#   python3 get_systempackage_by_systemkey_sspcontrolmatrix_file.py \
...
PATH_TEMPLATE = '/systempackage/{systemKey}/sspcontrolmatrix'
HTTP_METHOD = 'GET'
...
def determine_output_path(response, options: dict[str, str], system_key: str) -> Path:
    ...
    filename = f"{safe_system_key}_ssp-control-matrix_{timestamp}.{extension}"
