#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Systempackages
# API Path   : GET /systempackages
# Description: Retrieves data from the /systempackages endpoint. The response is parsed as JSON and printed with standard indentation.
#
# Required Parameters:
...
#   python3 get_systempackages_json.py \
