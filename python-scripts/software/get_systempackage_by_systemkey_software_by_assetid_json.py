#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Systempackage Software
# API Path   : GET /systempackage/{systemKey}/software/{assetId}
# Description: Retrieves data from the /systempackage/{systemKey}/software/{assetId} endpoint. The response is parsed as JSON and printed with standard indentation.
#
# Required Parameters:
...
#   python3 get_systempackage_by_systemkey_software_by_assetid_json.py \
...
PATH_TEMPLATE = '/systempackage/{systemKey}/software/{assetId}'
HTTP_METHOD = 'GET'
