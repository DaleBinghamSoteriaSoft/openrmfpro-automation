...
# API Path   : DELETE /systempackage/{systemKey}/softwareasset/{ppsId}
# Description: Deletes data through the /systempackage/{systemKey}/softwareasset/{ppsId} endpoint. The script reports the HTTP status code and a human-readable meaning.
#
# Required Parameters:
...
#
# Optional Parameters:
#    - assetId (query), type: string
#
# Command Line Example:
#   python3 delete_systempackage_by_systemkey_softwareasset_by_ppsid.py \
...
PATH_TEMPLATE = '/systempackage/{systemKey}/softwareasset/{ppsId}'
HTTP_METHOD = 'DELETE'
