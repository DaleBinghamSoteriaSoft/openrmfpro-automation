#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Systempackage Software File
# API Path   : GET /systempackage/{systemKey}/software
# Description: Retrieves data from the /systempackage/{systemKey}/software endpoint and saves the response body to a local Excel file.
#
# Required Parameters:
...
#   python3 get_systempackage_by_systemkey_software_file.py \
...
PATH_TEMPLATE = '/systempackage/{systemKey}/software'
HTTP_METHOD = 'GET'
...
def determine_output_path(options: dict[str, str], system_key: str) -> Path:
    ...
    return downloads_root / f"{safe_system_key}-software-list-{timestamp}.{FILE_EXTENSION_HINT}"
