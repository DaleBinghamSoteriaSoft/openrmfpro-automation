#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Systempackage Softwareasset
# API Path   : PUT /systempackage/{systemKey}/softwareasset/{assetId}
# Description: Updates data on the /systempackage/{systemKey}/softwareasset/{assetId} endpoint. The script reports the HTTP status code and a human-readable meaning.
#
# Required Parameters:
...
#   7) softwareName       - Required multipart form field (string).
#   8) softwareVersion    - Required multipart form field (string).
#   9) assetType          - Required multipart form field (string).
#   10) installedOn        - Required multipart form field (string).
#   11) approvalReference  - Required multipart form field (string).
#
# Optional Parameters:
#   None
#
# Command Line Example:
#   python3 put_systempackage_by_systemkey_softwareasset_by_assetid.py \
...
PATH_TEMPLATE = '/systempackage/{systemKey}/softwareasset/{assetId}'
HTTP_METHOD = 'PUT'
...
positional_values = sys.argv[4:4 + 8]
optional_values = sys.argv[4 + 8:]
