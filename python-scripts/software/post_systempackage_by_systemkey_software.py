...
# API Path   : POST /systempackage/{systemKey}/software
# Description: Submits data to the /systempackage/{systemKey}/software endpoint. The script reports the HTTP status code and a human-readable meaning.
#
# Required Parameters:
...
#   5) softwareFile       - Required multipart form file path.
#
# Optional Parameters:
#   None
#
# Command Line Example:
#   python3 post_systempackage_by_systemkey_software.py \
