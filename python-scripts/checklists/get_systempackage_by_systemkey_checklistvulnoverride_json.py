#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Systempackage Checklistvulnoverride
# API Path   : GET /systempackage/{systemKey}/checklistvulnoverride
# Description: Retrieves data from the /systempackage/{systemKey}/checklistvulnoverride endpoint. The response is parsed as JSON and printed with standard indentation.
#
# Required Parameters:
...
#   python3 get_systempackage_by_systemkey_checklistvulnoverride_json.py \
...
PATH_TEMPLATE = '/systempackage/{systemKey}/checklistvulnoverride'
HTTP_METHOD = 'GET'
