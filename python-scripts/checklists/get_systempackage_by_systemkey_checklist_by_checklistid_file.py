#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Systempackage Checklist
# API Path   : GET /systempackage/{systemKey}/checklist/{checklistId}
# Description: Retrieves data from the /systempackage/{systemKey}/checklist/{checklistId} endpoint. The response body is saved to a local file.
#
# Required Parameters:
...
#   python3 get_systempackage_by_systemkey_checklist_by_checklistid_file.py \
...
PATH_TEMPLATE = '/systempackage/{systemKey}/checklist/{checklistId}'
HTTP_METHOD = 'GET'
