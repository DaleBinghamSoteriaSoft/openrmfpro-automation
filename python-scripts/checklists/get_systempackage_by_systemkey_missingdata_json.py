#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Systempackage Missingdata
# API Path   : GET /systempackage/{systemKey}/missingdata
# Description: Retrieves data from the /systempackage/{systemKey}/missingdata endpoint. The response is parsed as JSON and printed with standard indentation.
#
# Required Parameters:
...
#   python3 get_systempackage_by_systemkey_missingdata_json.py \
...
PATH_TEMPLATE = '/systempackage/{systemKey}/missingdata'
HTTP_METHOD = 'GET'
