...
# Description: Retrieves data from the /systempackage/{systemKey}/checklistrecord/{checklistId}/history endpoint. The response is parsed as JSON and rendered as a PrettyTable.
#
# Required Parameters:
...
#   python3 get_systempackage_by_systemkey_checklistrecord_by_checklistid_history_table.py \
