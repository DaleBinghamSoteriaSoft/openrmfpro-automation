#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Systempackage Checklistrecord
# API Path   : GET /systempackage/{systemKey}/checklistrecord/{checklistId}
# Description: Retrieves data from the /systempackage/{systemKey}/checklistrecord/{checklistId} endpoint. The response is parsed as JSON and printed with standard indentation.
#
# Required Parameters:
...
#   python3 get_systempackage_by_systemkey_checklistrecord_by_checklistid_json.py \
...
PATH_TEMPLATE = '/systempackage/{systemKey}/checklistrecord/{checklistId}'
HTTP_METHOD = 'GET'
