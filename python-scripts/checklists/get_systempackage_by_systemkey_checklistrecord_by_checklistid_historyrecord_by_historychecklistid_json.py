#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Systempackage Checklistrecord Historyrecord
# API Path   : GET /systempackage/{systemKey}/checklistrecord/{checklistId}/historyrecord/{historyChecklistId}
# Description: Retrieves data from the /systempackage/{systemKey}/checklistrecord/{checklistId}/historyrecord/{historyChecklistId} endpoint. The response is parsed as JSON and printed with standard indentation.
#
# Required Parameters:
...
#   python3 get_systempackage_by_systemkey_checklistrecord_by_checklistid_historyrecord_by_historychecklistid_json.py \
...
PATH_TEMPLATE = '/systempackage/{systemKey}/checklistrecord/{checklistId}/historyrecord/{historyChecklistId}'
HTTP_METHOD = 'GET'
