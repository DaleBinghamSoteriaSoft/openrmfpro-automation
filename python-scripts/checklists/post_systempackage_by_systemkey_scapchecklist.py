#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Systempackage Scapchecklist
# API Path   : POST /systempackage/{systemKey}/scapchecklist
# Description: Submits data to the /systempackage/{systemKey}/scapchecklist endpoint. The script reports the HTTP status code and a human-readable meaning.
#
# Required Parameters:
...
#   5) checklistFile      - Required multipart form file path sent as form field checklistFile.
#
# Optional Parameters:
#   None
#
# Command Line Example:
#   python3 post_systempackage_by_systemkey_scapchecklist.py \
...
PATH_TEMPLATE = '/systempackage/{systemKey}/scapchecklist'
HTTP_METHOD = 'POST'
