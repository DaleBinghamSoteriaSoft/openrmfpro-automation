...
# API Path   : DELETE /systempackage/{systemKey}/checklist/{checklistId}
# Description: Deletes data through the /systempackage/{systemKey}/checklist/{checklistId} endpoint. The script reports the HTTP status code and a human-readable meaning.
#
# Required Parameters:
...
#
# Optional Parameters:
#    - comment (multipart form), type: string, default:
#
# Command Line Example:
#   python3 delete_systempackage_by_systemkey_checklist_by_checklistid.py \
