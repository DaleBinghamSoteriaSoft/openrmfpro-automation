#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Systempackage Checklistrecord History
# API Path   : GET /systempackage/{systemKey}/checklistrecord/{checklistId}/history
# Description: Retrieves data from the /systempackage/{systemKey}/checklistrecord/{checklistId}/history endpoint. The response is parsed as JSON and printed with standard indentation.
#
# Required Parameters:
...
#
# Optional Parameters:
#    - listAllHistories (query), type: boolean, default: False
#
# Command Line Example:
#   python3 get_systempackage_by_systemkey_checklistrecord_by_checklistid_history_json.py \
...
PATH_TEMPLATE = '/systempackage/{systemKey}/checklistrecord/{checklistId}/history'
HTTP_METHOD = 'GET'
