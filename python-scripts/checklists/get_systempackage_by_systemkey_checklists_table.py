#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Systempackage Checklists
# API Path   : GET /systempackage/{systemKey}/checklists
# Description: Retrieves data from the /systempackage/{systemKey}/checklists endpoint. The response is parsed as JSON and rendered as a PrettyTable.
#
# Required Parameters:
...
#   python3 get_systempackage_by_systemkey_checklists_table.py \
...
PATH_TEMPLATE = '/systempackage/{systemKey}/checklists'
HTTP_METHOD = 'GET'
