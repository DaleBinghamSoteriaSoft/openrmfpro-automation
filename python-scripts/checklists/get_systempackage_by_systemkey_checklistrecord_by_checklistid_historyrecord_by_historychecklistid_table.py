...
# Description: Retrieves data from the /systempackage/{systemKey}/checklistrecord/{checklistId}/historyrecord/{historyChecklistId} endpoint. The response is parsed as JSON and rendered as a PrettyTable.
#
# Required Parameters:
...
#   python3 get_systempackage_by_systemkey_checklistrecord_by_checklistid_historyrecord_by_historychecklistid_table.py \
