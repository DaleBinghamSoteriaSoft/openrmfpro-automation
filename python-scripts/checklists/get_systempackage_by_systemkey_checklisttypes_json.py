#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Systempackage Checklisttypes
# API Path   : GET /systempackage/{systemKey}/checklisttypes
# Description: Retrieves data from the /systempackage/{systemKey}/checklisttypes endpoint. The response is parsed as JSON and printed with standard indentation.
#
# Required Parameters:
...
#   python3 get_systempackage_by_systemkey_checklisttypes_json.py \
...
PATH_TEMPLATE = '/systempackage/{systemKey}/checklisttypes'
HTTP_METHOD = 'GET'
