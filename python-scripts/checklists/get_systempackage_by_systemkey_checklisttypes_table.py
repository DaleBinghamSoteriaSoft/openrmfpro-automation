...
# Description: Retrieves data from the /systempackage/{systemKey}/checklisttypes endpoint. The response is parsed as JSON and rendered as a PrettyTable.
#
# Required Parameters:
...
#   python3 get_systempackage_by_systemkey_checklisttypes_table.py \
