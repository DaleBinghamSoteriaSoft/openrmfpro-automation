#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Systempackage Bulkadd
# API Path   : POST /systempackage/{systemKey}/bulkadd
# Description: Submits data to the /systempackage/{systemKey}/bulkadd endpoint. The script reports the HTTP status code and a human-readable meaning.
#
# Required Parameters:
...
#   5) templateIds        - Required multipart form field (string).
#
# Optional Parameters:
#    - checklistHostname (multipart form), type: string, default:
#
# Command Line Example:
#   python3 post_systempackage_by_systemkey_bulkadd.py \
...
PATH_TEMPLATE = '/systempackage/{systemKey}/bulkadd'
HTTP_METHOD = 'POST'
