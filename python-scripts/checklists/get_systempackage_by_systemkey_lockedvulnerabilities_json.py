#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Systempackage Lockedvulnerabilities
# API Path   : GET /systempackage/{systemKey}/lockedvulnerabilities
# Description: Retrieves data from the /systempackage/{systemKey}/lockedvulnerabilities endpoint. The response is parsed as JSON and printed with standard indentation.
#
# Required Parameters:
...
#
# Optional Parameters:
#    - notafinding (query), type: boolean, default: True
#    - open (query), type: boolean, default: True
#    - notapplicable (query), type: boolean, default: True
#    - notreviewed (query), type: boolean, default: True
#    - category1 (query), type: boolean, default: True
#    - category2 (query), type: boolean, default: True
#    - category3 (query), type: boolean, default: True
#    - page (query), type: integer, default: 1
#    - limit (query), type: integer, default: 50
#    - searchString (query), type: string, default:
#
# Command Line Example:
#   python3 get_systempackage_by_systemkey_lockedvulnerabilities_json.py \
...
PATH_TEMPLATE = '/systempackage/{systemKey}/lockedvulnerabilities'
HTTP_METHOD = 'GET'
