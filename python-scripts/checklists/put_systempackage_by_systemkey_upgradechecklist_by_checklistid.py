#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Systempackage Upgradechecklist
# API Path   : PUT /systempackage/{systemKey}/upgradechecklist/{checklistId}
# Description: Updates data on the /systempackage/{systemKey}/upgradechecklist/{checklistId} endpoint. The script reports the HTTP status code and a human-readable meaning.
#
# Required Parameters:
...
#   python3 put_systempackage_by_systemkey_upgradechecklist_by_checklistid.py \
...
PATH_TEMPLATE = '/systempackage/{systemKey}/upgradechecklist/{checklistId}'
HTTP_METHOD = 'PUT'
