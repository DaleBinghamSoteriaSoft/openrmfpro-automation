#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Systempackage Checklistdifference
# API Path   : POST /systempackage/{systemKey}/checklistdifference
# Description: Submits data to the /systempackage/{systemKey}/checklistdifference endpoint. The script reports the HTTP status code and a human-readable meaning.
#
# Required Parameters:
...
#   5) checklistType      - Required multipart form field (string).
#   6) devices            - Required multipart form field (string).
#
# Optional Parameters:
#   None
#
# Command Line Example:
#   python3 post_systempackage_by_systemkey_checklistdifference.py \
...
PATH_TEMPLATE = '/systempackage/{systemKey}/checklistdifference'
HTTP_METHOD = 'POST'
