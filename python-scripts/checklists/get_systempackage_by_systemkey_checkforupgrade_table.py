...
# Description: Retrieves data from the /systempackage/{systemKey}/checkforupgrade endpoint. The response is parsed as JSON and rendered as a PrettyTable.
#
# Required Parameters:
...
#   python3 get_systempackage_by_systemkey_checkforupgrade_table.py \
        ...
        if not payload:
            ...
            for item in payload:
                for key in item.keys():
                    if key not in field_names and key != 'rawData':
