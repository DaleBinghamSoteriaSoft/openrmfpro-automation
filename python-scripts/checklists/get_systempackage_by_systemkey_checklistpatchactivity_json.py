#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Systempackage Checklistpatchactivity
# API Path   : GET /systempackage/{systemKey}/checklistpatchactivity
# Description: Retrieves data from the /systempackage/{systemKey}/checklistpatchactivity endpoint. The response is parsed as JSON and printed with standard indentation.
#
# Required Parameters:
...
#   python3 get_systempackage_by_systemkey_checklistpatchactivity_json.py \
...
PATH_TEMPLATE = '/systempackage/{systemKey}/checklistpatchactivity'
HTTP_METHOD = 'GET'
