#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Systempackage Checklist Vulnid
# API Path   : PUT /systempackage/{systemKey}/checklist/{checklistId}/vulnid/{vulnid}
# Description: Updates data on the /systempackage/{systemKey}/checklist/{checklistId}/vulnid/{vulnid} endpoint. The script reports the HTTP status code and a human-readable meaning.
#
# Required Parameters:
...
#   6) vulnId             - Required path parameter.
#   7) status             - Required multipart form field (string).
#
# Optional Parameters:
#    - comments (multipart form), type: string, default:
#    - details (multipart form), type: string, default:
#    - severityOverride (multipart form), type: string, default:
#    - justification (multipart form), type: string, default:
#    - locked (multipart form), type: boolean, default: False
#
# Command Line Example:
#   python3 put_systempackage_by_systemkey_checklist_by_checklistid_vulnid_by_vulnid.py \
...
PATH_TEMPLATE = '/systempackage/{systemKey}/checklist/{checklistId}/vulnid/{vulnid}'
HTTP_METHOD = 'PUT'
...
positional_values = sys.argv[4:4 + 4]
optional_values = sys.argv[4 + 4:]
