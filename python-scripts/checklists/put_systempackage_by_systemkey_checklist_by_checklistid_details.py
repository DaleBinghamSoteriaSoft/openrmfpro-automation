#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Systempackage Checklist Details
# API Path   : PUT /systempackage/{systemKey}/checklist/{checklistId}/details
# Description: Updates data on the /systempackage/{systemKey}/checklist/{checklistId}/details endpoint. The script reports the HTTP status code and a human-readable meaning.
#
# Required Parameters:
...
#   5) checklistId        - Required path parameter.
#
# Optional Parameters:
#    - serverhostname (multipart form), type: string, default:
#    - fqdn (multipart form), type: string, default:
#    - techarea (multipart form), type: string, default:
#    - hostip (multipart form), type: string, default:
#    - hostmac (multipart form), type: string, default:
#    - webordatabase (multipart form), type: string, default: false
#    - webdatabasesite (multipart form), type: string, default:
#    - webdatabaseinstance (multipart form), type: string, default:
#    - assettype (multipart form), type: string, default:
#    - machinerole (multipart form), type: string, default:
#    - marking (multipart form), type: string, default:
#    - tagList (multipart form), type: string, default:
#    - nothostrelated (multipart form), type: boolean, default: False
#    - locked (multipart form), type: boolean, default: False
#
# Command Line Example:
#   python3 put_systempackage_by_systemkey_checklist_by_checklistid_details.py \
...
PATH_TEMPLATE = '/systempackage/{systemKey}/checklist/{checklistId}/details'
HTTP_METHOD = 'PUT'
