#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Notifications
# API Path   : GET /notifications
# Description: Retrieves data from the /notifications endpoint. The response is parsed as JSON and printed with standard indentation.
#
# Required Parameters:
...
#
# Optional Parameters:
#    - bShowAll (query), type: boolean, default: False
#    - systemKey (query), type: string, default:
#    - notificationType (query), type: string, default:
#
# Command Line Example:
#   python3 get_notifications_json.py \
