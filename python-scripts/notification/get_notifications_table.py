...
# Description: Retrieves data from the /notifications endpoint. The response is parsed as JSON and rendered as a PrettyTable.
#
# Required Parameters:
...
#   python3 get_notifications_table.py \
