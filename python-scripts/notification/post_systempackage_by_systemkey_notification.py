#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Systempackage Notification
# API Path   : POST /systempackage/{systemKey}/notification
# Description: Submits data to the /systempackage/{systemKey}/notification endpoint. The script reports the HTTP status code and a human-readable meaning.
#
# Required Parameters:
...
#   6) message            - Required multipart form field (string).
#   7) notificationType   - Required multipart form field (string).
#
# Optional Parameters:
#   None
#
# Command Line Example:
#   python3 post_systempackage_by_systemkey_notification.py \
...
PATH_TEMPLATE = '/systempackage/{systemKey}/notification'
HTTP_METHOD = 'POST'
