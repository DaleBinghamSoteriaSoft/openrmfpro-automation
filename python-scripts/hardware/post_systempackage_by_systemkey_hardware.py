...
# API Path   : POST /systempackage/{systemKey}/hardware
# Description: Submits data to the /systempackage/{systemKey}/hardware endpoint. The script reports the HTTP status code and a human-readable meaning.
#
# Required Parameters:
...
#   5) hardwareFile       - Required multipart form file path.
#
# Optional Parameters:
#   None
#
# Command Line Example:
#   python3 post_systempackage_by_systemkey_hardware.py \
