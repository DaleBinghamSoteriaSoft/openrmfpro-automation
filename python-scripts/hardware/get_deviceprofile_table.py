...
# Description: Retrieves data from the /deviceprofile endpoint. The response is parsed as JSON and rendered as a PrettyTable.
#
# Required Parameters:
...
#   python3 get_deviceprofile_table.py \
