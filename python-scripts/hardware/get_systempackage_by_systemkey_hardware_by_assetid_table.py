...
# Description: Retrieves data from the /systempackage/{systemKey}/hardware/{assetId} endpoint. The response is parsed as JSON and rendered as a PrettyTable.
#
# Required Parameters:
...
#   python3 get_systempackage_by_systemkey_hardware_by_assetid_table.py \
