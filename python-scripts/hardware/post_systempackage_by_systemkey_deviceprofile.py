...
# API Path   : POST /systempackage/{systemKey}/deviceprofile
# Description: Submits data to the /systempackage/{systemKey}/deviceprofile endpoint. The script reports the HTTP status code and a human-readable meaning.
#
# Required Parameters:
...
#   5) deviceProfileFile  - Required multipart form file path.
#
# Optional Parameters:
#   None
#
# Command Line Example:
#   python3 post_systempackage_by_systemkey_deviceprofile.py \
