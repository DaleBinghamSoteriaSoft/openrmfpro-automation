...
# API Path   : PUT /systempackage/{systemKey}/deviceprofile/{deviceProfileId}
# Description: Updates data on the /systempackage/{systemKey}/deviceprofile/{deviceProfileId} endpoint. The script reports the HTTP status code and a human-readable meaning.
#
# Required Parameters:
...
#   python3 put_systempackage_by_systemkey_deviceprofile_by_deviceprofileid.py \
