#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Deviceprofile
# API Path   : GET /deviceprofile
# Description: Retrieves data from the /deviceprofile endpoint. The response is parsed as JSON and printed with standard indentation.
#
# Required Parameters:
...
#   python3 get_deviceprofile_json.py \
