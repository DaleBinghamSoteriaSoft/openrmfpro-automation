#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Systempackage Deviceprofile
# API Path   : DELETE /systempackage/{systemKey}/deviceprofile/{deviceProfileId}
# Description: Deletes data through the /systempackage/{systemKey}/deviceprofile/{deviceProfileId} endpoint. The script reports the HTTP status code and a human-readable meaning.
#
# Required Parameters:
...
#   5) deviceProfileId    - Required path parameter.
#
# Optional Parameters:
#   None
#
# Command Line Example:
#   python3 delete_systempackage_by_systemkey_deviceprofile_by_deviceprofileid.py \
...
PATH_TEMPLATE = '/systempackage/{systemKey}/deviceprofile/{deviceProfileId}'
HTTP_METHOD = 'DELETE'
