#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Systempackage Hardware
# API Path   : DELETE /systempackage/{systemKey}/hardware/{assetId}
# Description: Deletes data through the /systempackage/{systemKey}/hardware/{assetId} endpoint. The script reports the HTTP status code and a human-readable meaning.
#
# Required Parameters:
...
#   python3 delete_systempackage_by_systemkey_hardware_by_assetid.py \
...
PATH_TEMPLATE = '/systempackage/{systemKey}/hardware/{assetId}'
HTTP_METHOD = 'DELETE'
