...
# API Path   : GET /systempackage/{systemKey}/hardware/{assetId}
# Description: Retrieves data from the /systempackage/{systemKey}/hardware/{assetId} endpoint. The response is parsed as JSON and printed with standard indentation.
#
# Required Parameters:
...
#   python3 get_systempackage_by_systemkey_hardware_by_assetid_json.py \
