#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Systempackage Audit
# API Path   : GET /systempackage/{systemKey}/audit
# Description: Retrieves data from the /systempackage/{systemKey}/audit endpoint. The response is parsed as JSON and printed with standard indentation.
#
# Required Parameters:
...
#   python3 get_systempackage_by_systemkey_audit_json.py \
