...
# Description: Retrieves data from the /systempackage/{systemKey}/approvedpps endpoint. The response is parsed as JSON and rendered as a PrettyTable.
#
# Required Parameters:
...
#   python3 get_systempackage_by_systemkey_approvedpps_table.py \
