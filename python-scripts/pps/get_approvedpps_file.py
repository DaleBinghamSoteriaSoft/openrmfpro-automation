#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Approvedpps File
# API Path   : GET /approvedpps
# Description: Retrieves data from the /approvedpps endpoint and saves the response body to a local Excel file.
#
# Required Parameters:
...
#   python3 get_approvedpps_file.py \
...
# -------------------------------------------------------
def determine_output_path(options: dict[str, str]) -> Path:
    ...
    return downloads_root / f"approved-pps-list-{timestamp}.{FILE_EXTENSION_HINT}"
...
if 200 <= response.status_code < 300:
    output_path = determine_output_path(optional_arguments)
