...
# API Path   : POST /systempackage/{systemKey}/ppsm
# Description: Submits data to the /systempackage/{systemKey}/ppsm endpoint. The script reports the HTTP status code and a human-readable meaning.
#
# Required Parameters:
...
#   5) ppsmFile           - Required multipart form file path.
#
# Optional Parameters:
#   None
#
# Command Line Example:
#   python3 post_systempackage_by_systemkey_ppsm.py \
