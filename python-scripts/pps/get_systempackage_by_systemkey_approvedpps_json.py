...
# Description: Retrieves data from the /systempackage/{systemKey}/approvedpps endpoint. The response is parsed as JSON and printed with standard indentation.
#
# Required Parameters:
...
#   python3 get_systempackage_by_systemkey_approvedpps_json.py \
