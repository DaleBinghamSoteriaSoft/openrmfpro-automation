...
# API Path   : DELETE /systempackage/{systemKey}/pps/{ppsId}
# Description: Deletes data through the /systempackage/{systemKey}/pps/{ppsId} endpoint. The script reports the HTTP status code and a human-readable meaning.
#
# Required Parameters:
...
#   python3 delete_systempackage_by_systemkey_pps_by_ppsid.py \
