#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Templates
# API Path   : GET /templates/{templateType}
# Description: Retrieves data from the /templates/{templateType} endpoint. The response is parsed as JSON and printed with standard indentation.
#
# Required Parameters:
...
#   4) templateType       - Required path parameter.
#
# Optional Parameters:
#    - searchString (query), type: string, default:
#
# Command Line Example:
#   python3 get_templates_by_templatetype_json.py \
...
PATH_TEMPLATE = '/templates/{templateType}'
HTTP_METHOD = 'GET'
