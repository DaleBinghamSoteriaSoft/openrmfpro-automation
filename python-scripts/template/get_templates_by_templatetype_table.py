...
# Description: Retrieves data from the /templates/{templateType} endpoint. The response is parsed as JSON and rendered as a PrettyTable.
#
# Required Parameters:
...
#   python3 get_templates_by_templatetype_table.py \
