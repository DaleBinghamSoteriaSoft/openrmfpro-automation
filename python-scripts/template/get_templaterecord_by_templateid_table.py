...
# Description: Retrieves data from the /templaterecord/{templateId} endpoint. The response is parsed as JSON and rendered as a PrettyTable.
#
# Required Parameters:
...
#   python3 get_templaterecord_by_templateid_table.py \
