#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Templaterecord
# API Path   : GET /templaterecord/{templateId}
# Description: Retrieves data from the /templaterecord/{templateId} endpoint. The response is parsed as JSON and printed with standard indentation.
#
# Required Parameters:
...
#   python3 get_templaterecord_by_templateid_json.py \
...
PATH_TEMPLATE = '/templaterecord/{templateId}'
HTTP_METHOD = 'GET'
