#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Template Organization
# API Path   : POST /template/organization
# Description: Submits data to the /template/organization endpoint. The script reports the HTTP status code and a human-readable meaning.
#
# Required Parameters:
...
#   4) templateFile       - Required multipart form file path.
#
# Optional Parameters:
...
#   python3 post_template_organization.py \
...
PATH_TEMPLATE = '/template/organization'
HTTP_METHOD = 'POST'
