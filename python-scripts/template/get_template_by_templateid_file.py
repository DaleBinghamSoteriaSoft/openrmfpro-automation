#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Template
# API Path   : GET /template/{templateId}
# Description: Retrieves data from the /template/{templateId} endpoint. The response body is saved to a local file.
#
# Required Parameters:
...
#   4) templateId         - Required path parameter.
#
# Optional Parameters:
...
#   python3 get_template_by_templateid_file.py \
...
PATH_TEMPLATE = '/template/{templateId}'
HTTP_METHOD = 'GET'
