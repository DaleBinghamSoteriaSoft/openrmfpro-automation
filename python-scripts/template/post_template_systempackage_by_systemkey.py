#!/usr/bin/env python3
# ============================================================
# OpenRMF Professional External API - Template Systempackage
# API Path   : POST /template/systempackage/{systemKey}
# Description: Submits data to the /template/systempackage/{systemKey} endpoint. The script reports the HTTP status code and a human-readable meaning.
#
# Required Parameters:
...
#   5) templateFile       - Required multipart form file path.
#
# Optional Parameters:
#    - title (multipart form), type: string, default:
#    - description (multipart form), type: string, default:
#
# Command Line Example:
#   python3 post_template_systempackage_by_systemkey.py \
...
PATH_TEMPLATE = '/template/systempackage/{systemKey}'
HTTP_METHOD = 'POST'
